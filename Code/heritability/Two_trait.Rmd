...
ggplot() +
  ...
  geom_errorbar(data=sum.dat, aes(x=life, ymin=fec-fecse, ymax=fec+fecse), width=3) +
  geom_errorbarh(data=sum.dat, aes(x=life, y=fec, xmin=life-lifese, xmax=life+lifese), height=5) +
  #geom_smooth(se = FALSE, method = "lm") +
  tx_color_map() +
  tx_fill_map()
