...
#pdf("../../Figures/h2_avg_fecundity_per_female_per_day.pdf",width=12,height=4)

lml <- ggplot(data=AB.c, aes(x=age, y=eggs_per_female, color=Diet)) +
geom_point(position = position_jitter(width = .4), alpha = 0.2) +
