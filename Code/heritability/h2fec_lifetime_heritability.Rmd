...
#pdf("../../Data/Figures/heritability_lifetime_plots.pdf",width=6,height=4)
par(mar = c(4.5, 4.5, 0.5, 0.5))
 ggplot(heritab, aes(var1, fill = Diet)) + 
  geom_density(alpha = 0.2) +
  geom_segment(x = 0.2479849,
               y = ll + ss,
               xend = 0.4984068,
               yend = ll+ss,
               position = "identity",
               colour = "mediumpurple1")+
  geom_segment(x = 0.2479,
               y = ll+ss+ss,
               xend = 0.4986,
               yend = ll+ss+ss,
               position = "identity",
               colour = "darkseagreen2")+
  geom_segment(x = 0.0001595,
               y = ll,
               xend = 0.158,
               yend = ll,
               position = "identity",
...
# correlate lifespan and fecundity
