...
fm2 <- stan_glm(egg_total_c ~ treat, data = early.fec,
                iter = iter)
fm3 <- stan_lmer(egg_total_c ~ 1 + (1 | sireid) + (1 | sireid:damid),
                 data = early.fec,
                 iter = iter)
fm4 <- stan_lmer(egg_total_c ~ treat + (1 | sireid), data = early.fec,
                 iter = iter)
fm5 <- stan_lmer(egg_total_c ~ treat + (1 | sireid) + (1 | sireid:damid),
                 data = early.fec,
                 iter = iter)
fm6 <- stan_lmer(egg_total_c ~ treat + (1 | sireid) + (1 | sireid:damid) + (treat - 1 | sireid),
                 data = early.fec,
                 control = list(adapt_delta = 0.99),
                 iter = iter)
fm7 <- stan_lmer(egg_total_c ~ treat + (1 | sireid:damid),
                 data = early.fec,
                 iter = iter)
...
loo_fm7 <- loo(fm7, k_threshold = 0.7)
```

```{r}
compare_models(loos = list(loo_fm1, loo_fm2, loo_fm3, loo_fm4, loo_fm5, loo_fm6, loo_fm7))
loo_model_weights(list(loo_fm1, loo_fm2, loo_fm3, loo_fm4, loo_fm5, loo_fm6, loo_fm7))
loo_model_weights(list(loo_fm5, loo_fm7))
```
...
fm3 <- stan_lmer(egg_total_c ~ 1 + (1 | sireid) + (1 | sireid:damid),
                 data = h2fec,
                 iter = iter)
fm4 <- stan_lmer(egg_total_c ~ treat + (1 | sireid), data = h2fec,
                 iter = iter)
fm5 <- stan_lmer(egg_total_c ~ treat + (1 | sireid) + (1 | sireid:damid),
                 data = h2fec,
                 iter = iter)
