...
if (FALSE) {
  ...
  bm6 <- brm(NewAge | cens(censored) ~ diet + (1 | sireid) + (1 | sireid:damid) +
             ...
             inits = "0",
             cores = 4)
  bm7 <- brm(NewAge | cens(censored) ~ diet + (1 | sireid) + (1 | sireid:damid) +
               (1 | diet:sireid) + (1 | damid:repl),
             data = h2life_2,
             family = weibull(),
             inits = "0",
             cores = 4)
  loo_comp <- loo(bm1, bm2, bm3, bm4, bm5, bm6, bm7)
  model_wts <- model_weights(bm1, bm2, bm3, bm4, bm5, bm6, bm7)

  save(list = c("bm1", "bm2", "bm3", "bm4", "bm5", "bm6", "bm7",
                "loo_comp", "model_wts"),
...
coda::HPDinterval(as.mcmc(STD_DR))
coda::HPDinterval(as.mcmc(STD_HS))
coda::HPDinterval(as.mcmc(DR_HS))
```
