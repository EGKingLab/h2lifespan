...
```{r, dens}
pdf("../../Figures/density_all-life_data.pdf",width=6,height=4)
...
legend(80,1, c("C", "DR", "HS"), lwd = 3,
       text.font = 1, bty = "n", y.intersp = 1.0, 
       col = pal)
mm
#dev.off()
```
...
# survival
pdf("../../Figures/K-M_treat_summarized_survminer.pdf", width = 8, height = 6)
par(mar=c(6.0,6.0,0.5,0.5))
