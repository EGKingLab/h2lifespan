...
prior <- list(R = list(V = fvg1, nu = 0.002),
              G = list(G1 = list(V = 1, nu = 0.002)))
...
ggplot(heritab, aes(var1, fill = Diet)) + 
  ...
  geom_segment(x = 0.2479849, y = ll+ss, xend = 0.4984068,
               yend = ll+ss, position = "identity", colour = "mediumpurple1")+
  geom_segment(x = 0.2071338, y = ll+ss+ss, xend = 0.4288147,
               yend = ll+ss+ss, position = "identity", colour = "darkseagreen2")+
  geom_segment(x = 0.3350174, y = ll, xend = 0.6070656,
               yend = ll, position = "identity", colour = "lightpink")+
